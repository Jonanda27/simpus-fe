...
export default function MonitoringEncounterPage() {
  ...
  const FHIR_RESOURCES = [
    ...
    { id: 'ServiceRequest', label: 'ServiceRequest (Surat Rujukan / Order Radiologi)' },
    { id: 'ImagingStudy', label: 'ImagingStudy (Citra DICOM WADO NIDR)' },
    { id: 'DiagnosticReport', label: 'DiagnosticReport (Laporan Lab & Radiologi)' },
